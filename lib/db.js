...
export const pgPool = USE_POSTGRES
  ? new pg.Pool({
      ...
      ssl: /sslmode=require|neon\.tech|vercel-storage|rds\.amazonaws/i.test(process.env.DATABASE_URL)
  ...
  try {
    ...
    for (const c of CATEGORIES) {
      const r = await client.query(
        'INSERT INTO categories (name, slug, emoji, tagline, sort) VALUES ($1,$2,$3,$4,$5) RETURNING id',
